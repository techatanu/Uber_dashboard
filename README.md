...
- **Tableau**: dashboard creation + interactive analysis (`UBER dashboard.twb`)
- **Excel**: raw and processed datasets (`UBER_RAW.xlsx`, `UBER_Clean.xlsx`)
- **Python**: automated chart generation for static exports in `charts/`

## Project structure

- `README.md`: project documentation
- `UBER dashboard.twb`: Tableau workbook with interactive dashboard
- `UBER_RAW.xlsx`: original dataset containing raw data
- `UBER_Clean.xlsx`: processed dataset ready for analysis
- `charts/`: dashboard screenshots and static chart exports

## Review guide

1. **Start here**: browse the dashboard preview and 3 key charts.
2. **Interactive exploration**: open `UBER dashboard.twb` to use filters and drill-down features.
3. **Data validation**: examine `UBER_RAW.xlsx` / `UBER_Clean.xlsx` for data quality.
